    ...
    >
      ...
      <dl class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 text-base text-slate-400 leading-7 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
        ...
        <div>
          ...
          <dd class="mt-1"><span className='italic text-salvify-accent-light'>Reduce environmental impact</span> - Salvify aids in minimizing medical waste, contributing to a more sustainable healthcare system and a greener planet.</dd>
        </div>
      </dl>
    {/* </div> */}
