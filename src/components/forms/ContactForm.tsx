...
const ContactForm = () => {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const clientResult = contactRequestSchema.safeParse(payload)
    ...
    if (!clientResult.success) {
      ...
      setIsLoading(false)
      focusFirstErrorField(form, fieldErrors)
      return
    }

    try {
      await axios.post('/api/contact-request', clientResult.data)
  ...
  return (
    <div className="flex w-full flex-col">
      <div className="-mx-4 mt-4 flex-auto rounded-2xl bg-surface px-4 py-6 shadow-lg sm:mx-0 sm:flex-none sm:p-24">
            ...
            {isSuccess && (
              ...
              >
                <p className="flex items-center text-surface">
                  ...
                  message has been received and we will get back to you shortly.
                </p>
              </div>
            )}
            ...
            {isError && (
              ...
              >
                <p className="flex items-center text-surface">
                  ...
                  <span className="font-semibold">Oh&nbsp;dear.</span>
                </p>
                <p className="mt-2 text-surface">
                  There has been a problem while sending your message. Please
