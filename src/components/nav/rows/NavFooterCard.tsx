...
const NavFooterCard = ({ name, href, image, onClick }: Props) => {
  return (
    ...
    >
      <div className="relative flex h-full origin-center scale-100 flex-row gap-y-1 rounded-lg bg-surface shadow-sm transition-transform group-hover:scale-105 lg:flex-col">
        {image && (
          <Image
            src={image}
            alt={name}
